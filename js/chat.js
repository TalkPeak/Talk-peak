...
submitButton.addEventListener('click', async (e) => {
    ...
    if (userResponse) {
        ...
        // A 메시지 무작위 출력
        const randomIndex = Math.floor(Math.random() * (messages.length - 2)) + 2; // 메시지 3부터 끝까지의 인덱스
        ...
        setTimeout(() => {
            ...
            if (randomMessage.additional) {
                const additionalElement = document.createElement('p');
                additionalElement.innerText = randomMessage.additional;
